...
require.config({
    paths: {
        ...
        'd3-collection': '../bower_components/d3-collection/index',
        'd3-path': '../bower_components/d3-path/index',
        'd3-array': '../bower_components/d3-array/index',
        'd3-shape': '../bower_components/d3-shape/index',
        'd3-sankey': '../bower_components/d3-sankey/index',

...
const i18nErrors = require('find/nls/errors');
const errorCustomContactSupportTemplate = require('find/templates/app/util/error-custom-contact-support.html');
...
module.exports = generateErrorSupportMessage;

...
define([
    ...
    return substitution({
        ...
        'customizations.bigLogo.description': 'Upload a logo for the splash screen. This must be 135px \u00D7 45px.',
        ...
        'customizations.error.FILE_DIMENSIONS_INVALID': 'Image has invalid dimensions',
        'customizations.smallLogo': 'Small Logo',
        'customizations.smallLogo.description': 'Upload a logo for the navigation bar. This must be 144px \u00D7 22px.',
        ...
        'search.dates': 'Dates',
        'search.documentSelection.title': 'Document Selection',
        'search.documentSelection.all': 'All documents selected',
        'search.documentSelection.none': 'No documents selected',
        'search.documentSelection.whitelist': 'Documents selected: {0}',
        'search.documentSelection.blacklist': 'Documents excluded: {0}',
        'search.documentSelection.selectAll': 'Select All',
        'search.documentSelection.excludeAll': 'Exclude All',
        'search.documentSelection.end': 'Stop selecting documents',
        ...
        'search.preview.user.emailFieldName': 'Email Address',
        'search.preview.user.uidFieldName': 'User ID',
        ...
        'search.resultsSort.date': 'newest first',
        'search.resultsSort.reverseDate': 'oldest first',
        ...
        'search.resultsView.users.empty': 'No users matched',
        'search.resultsView.users.noQuery': 'No query text entered',
        'search.resultsView.users.error.fetchUsers': 'Error: could not retrieve users',
        'search.resultsView.related-users': 'Related Users',
        'search.resultsView.experts': 'Experts',
        ...
        'search.savedSearchControl.applyPolicy': 'Apply Policy\u2026',
        'search.savedSearchControl.applyPolicy.action': 'Apply Policy',
        'search.savedSearchControl.applyPolicy.modal.title': 'Select a policy to apply to these documents',
        'search.savedSearchControl.applyPolicy.label.placeholder': 'Reason',
        'search.savedSearchControl.applyPolicy.error.fetch': 'Error: could not retrieve policies',
        'search.savedSearchControl.applyPolicy.error.apply': 'Error: could not apply policy',
        'search.savedSearchControl.applyPolicy.message.empty': 'There are no configured policies',
        ...
        'search.sunburst.fieldPlaceholder.policy': 'Select a policy',
        ...
        'settings.communityAgentStore.description': 'The Agentstore server used by the Community server.  This is only required when using Related Users functionality.',
        'settings.communityAgentStore.title': 'Community Agentstore',
        'settings.communityAgentStore.disable': 'Disable Community Agentstore',
        'settings.communityAgentStore.disabled': 'Community Agentstore is disabled',
        'settings.communityAgentStore.enable': 'Enable Community Agentstore',
        'settings.communityAgentStore.enabled': 'Community Agentstore is enabled',
        ...
        'settings.queryManipulation.explicitProfiling': 'Enable explicit profiling',
        ...
        'settings.controlPoint.description': 'Enable applying ControlPoint policies to saved snapshots',
        'settings.controlPoint.title': 'ControlPoint',
        'settings.controlPoint.enable': 'Enable ControlPoint',
        'settings.controlPoint.enabled': 'ControlPoint is enabled',
        ...
        'settings.nifi.disable': 'Disable NiFi',
        'settings.nifi.disabled': 'NiFi is disabled',
        'settings.nifi.enable': 'Enable NiFi',
        'settings.nifi.enabled': 'NiFi is enabled',
        ...
        'settings.INVALID_CREDENTIALS': "The supplied credentials are invalid",

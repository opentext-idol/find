...
define([
    ...
    return substitution({
        ...
        'search.savedSearchControl.applyCPPolicy': 'Apply ControlPoint Policy\u2026',
        'search.savedSearchControl.applyCPPolicy.action': 'Apply Policy',
        'search.savedSearchControl.applyCPPolicy.modal.title': 'Select a ControlPoint policy to apply to these documents',
        'search.savedSearchControl.applyCPPolicy.error.fetch': 'Error: could not retrieve policies',
        'search.savedSearchControl.applyCPPolicy.error.apply': 'Error: could not apply policy',
        'search.savedSearchControl.applyCPPolicy.message.empty': 'There are no configured policies',

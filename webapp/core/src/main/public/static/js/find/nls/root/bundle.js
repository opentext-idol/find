...
define([
    ...
    return substitution({
        ...
        'dashboards.widget.lastRefresh.nextRefresh': 'Next refresh at {0}',
        'dashboards.widget.lastRefresh.refreshing': 'Refreshing {0} of {1} widgets',
        'dashboards.widget.lastRefresh.timeLastUpdated': 'Last updated at {0}',
        ...
        'search.document.comment': 'Comment',
        ...
        'settings.powerpoint.description': 'Configuration related to PPTX export',

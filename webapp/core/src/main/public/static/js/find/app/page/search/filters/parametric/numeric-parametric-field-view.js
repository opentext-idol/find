...
const NumericFieldDetailsModel = require('find/app/model/numeric-field-details-model');
const DateFieldDetailsModel = require('find/app/model/date-field-details-model');
...
const numericWidget = require('find/app/page/search/filters/parametric/numeric-widget');
const BucketedNumericParametricCollection = require('find/app/model/bucketed-numeric-collection');
const BucketedDateParametricCollection = require('find/app/model/bucketed-date-collection');
...
const template = require('find/templates/app/page/search/filters/parametric/numeric-parametric-field-view.html');
const numericInputTemplate = require('find/templates/app/page/search/filters/parametric/numeric-parametric-field-view-numeric-input.html');
...
module.exports = NumericParametricFieldView;

...
const SharedWithEveryoneModel = require('find/app/model/saved-searches/shared-with-everyone-model');
const SharedWithUsersCollection = require('find/app/model/saved-searches/shared-with-users-collection');
const NotSharedWithUsersCollection = require('find/app/model/saved-searches/not-shared-with-users-collection');
const SharedWithUsersItemView = require('find/app/util/shared-with-users-item-view');
const NotSharedWithUsersItemView = require('find/app/util/not-shared-with-users-item-view');
const FilteringCollection = require('find/app/util/filtering-collection');
const config = require('find/app/configuration');
const template = require('find/templates/app/util/sharing-options.html');

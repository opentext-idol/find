...
], function (Backbone, _, FilteredParametricFieldsCollection) {
    ...
    describe('Filtered parametric fields collection', function () {
        ...
        describe('after filtering by the letter "M"', function () {
            ...
            it('should set 3 parametric models', function () {
                expect(this.filteredParametricCollection.length).toBe(3);
            });
        });
        ...
        describe('after filtering by the letter "O"', function () {
            ...
            it('should show 3 models when the filter text is set to "o"', function () {
                expect(this.filteredParametricFieldsCollection.length).toBe(3);
                expect(this.filteredParametricFieldsCollection.at(0)).toBe(this.parametricFieldsCollection.at(0));
                expect(this.filteredParametricFieldsCollection.at(1)).toBe(this.parametricFieldsCollection.at(2));
                expect(this.filteredParametricFieldsCollection.at(2)).toBe(this.parametricFieldsCollection.at(3));
            });
            ...
            describe('after parametric collection update', function () {
                ...
                it('should show 2 models', function () {
                    expect(this.filteredParametricFieldsCollection.length).toBe(2);
                    expect(this.filteredParametricFieldsCollection.at(0)).toBe(this.parametricFieldsCollection.at(0));
                    expect(this.filteredParametricFieldsCollection.at(1)).toBe(this.parametricFieldsCollection.at(3));
                });

                it('should set 2 parametric models', function () {
                    expect(this.filteredParametricCollection.length).toBe(2);
                });
            });
        });
        ...
        describe('after filtering by the letters "Hobbes"', function () {
            ...
            it('should set 1 parametric model', function () {
                expect(this.filteredParametricCollection.length).toBe(1);
            });
        });
        ...
        describe('After changing a model in the original collection', function () {
            ...
            it('should update the model in the filtering collection', function () {
                expect(this.filteredParametricFieldsCollection.findWhere({id: 'Rambo'}).get('displayName')).toBe('Rocky');
            });

...
public abstract class AbstractDocumentsControllerTest<RQ extends QueryRequest<Q>, RS extends SuggestRequest<Q>, RC extends GetContentRequest<T>, S extends Serializable, Q extends QueryRestrictions<S>, T extends GetContentRequestIndex<S>, R extends SearchResult, E extends Exception> {
    ...
    public void query() throws E {
        documentsController.query("Some query text", 1, 30, null, Collections.emptyList(), null, null, null, null, true, 0, false, false, QueryRequest.QueryType.MODIFIED.name(), false);
        verify(documentsService).queryTextIndex(any());
    }

    @Test
    public void queryForPromotions() throws E {
        documentsController.query("Some query text", 1, 30, null, Collections.emptyList(), null, null, null, null, true, 0, false, false, QueryRequest.QueryType.PROMOTIONS.name(), false);
        verify(documentsService).queryTextIndex(any());
    }

    @Test
    public void queryPaginationTest() throws E {
        documentsController.query("Some query text", 30, 60, null, Collections.emptyList(), null, null, null, null, true, 0, false, false, QueryRequest.QueryType.MODIFIED.name(), false);
        verify(documentsService).queryTextIndex(any());
    }

...
const EntitySearchCollection = require('find/idol/app/model/entitysearch/entity-search-collection');
const prettyPrintNumberHelper = require('find/app/page/search/template-helpers/pretty-print-number-helper');
...
module.exports = SelectionEntitySearch;

...
public class VideoWidget extends DatasourceDependentWidgetBase<VideoWidget, VideoWidgetSettings> {
    ...
    public VideoWidget(final String name, final String type, final Integer x, final Integer y, final Integer width, final Integer height, final WidgetNameSetting displayWidgetName, final WidgetDatasource<?> datasource, final VideoWidgetSettings widgetSettings) {

...
node {
    ...
    stage 'Deploy'
        sh '''
            ...
            ANSIBLE_HOST_KEY_CHECKING=False ANSIBLE_ROLES_PATH=${FPLAYBOOKDIR}roles ansible-playbook ${FPLAYBOOKDIR}app-playbook.yml -vv -i ${FPLAYBOOKDIR}hosts --become-user=fenkins --extra-vars "docker_build_location=/home/fenkins/docker_build"
        '''

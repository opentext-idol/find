...
public class HodDocumentsController extends DocumentsController<ResourceIdentifier, HodSearchResult, HodErrorException> {
    ...
    @Override
    protected SearchRequest<ResourceIdentifier> parseRequestParamsToObject(final String text, final int resultsStart, final int maxResults, final String summary, final List<ResourceIdentifier> databases, final String fieldText, final String sort, final DateTime minDate, final DateTime maxDate, final boolean highlight, final boolean autoCorrect) {

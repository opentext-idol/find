...
define([
    ...
    return substitution({
        ...
        'search.savedSearches.confirm.deleteMessage': 'Are you sure you want to remove this search?',
        'search.savedSearches.confirm.deleteMessage.title': 'Delete saved search',
        'search.savedSearches.confirm.resetMessage': 'Are you sure you want to reset this search',

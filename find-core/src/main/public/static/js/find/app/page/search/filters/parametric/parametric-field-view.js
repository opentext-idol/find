define([
    ...
    return Backbone.View.extend({
        ...
        seeMoreButtonTemplate: _.template('<tr class="toggle-more clickable"><td><i class="hp-icon hp-plus"></i></td><td> <span class="toggle-more-text"><%-i18n["app.seeMore"]%></span></td></tr>'),
        ...
        toggleFacets: function(toggle) {
            ...
            this.collapsible.$('.toggle-more i').toggleClass('hp-minus', !toggle);
            this.collapsible.$('.toggle-more i').toggleClass('hp-add', toggle);

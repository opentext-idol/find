define([
    ...
    'backbone',
    'moment'
], function(mockFactory, configuration, DatesFilterModel, FiltersCollection, SelectedParametricValues, DatabasesCollection, QueryModel, i18n, fieldTextParser, Backbone, moment) {

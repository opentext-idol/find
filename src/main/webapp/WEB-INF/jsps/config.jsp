...
<html>
    <head>
        <title>Find - Configuration</title>
    ...
    <!--[if IE 7]>
        ...
        <script type="text/javascript" src="../static-${applicationVersion}/bower_components/requirejs/require.js" data-main="../static-${applicationVersion}/js/config.js"></script>
    </head>
    <body>
        <div class="page"></div>
    </body>

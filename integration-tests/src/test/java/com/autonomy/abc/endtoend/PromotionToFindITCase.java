...
public class PromotionToFindITCase extends ABCTestBase {

    public PromotionToFindITCase(TestConfig config, String browser, ApplicationType type, Platform platform) {
    ...
    public void testPromotionToFind() throws InterruptedException {
        ...
        assertThat(service.getResultTitles(),contains(triggerResults.toArray()));

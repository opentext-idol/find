...
@WebIntegrationTest({"server.port=0", "hp.find.persistentState = INMEMORY", "hp.find.databaseType=H2INMEMORY", "application.buildNumber=test", "mock.idol.authentication=false"})

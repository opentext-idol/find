...
@Service
public class ContentAciService extends AbstractConfigurableAciService {

    private final ConfigService<IdolFindConfig> configService;

    @Autowired
    public ContentAciService(@Qualifier("aciService") final AciService aciService, final ConfigService<IdolFindConfig> configService) {
        super(aciService);
